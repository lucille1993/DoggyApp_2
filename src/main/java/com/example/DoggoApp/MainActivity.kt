...
import com.example.DoggoApp.viewmodels.MainViewModel
import com.example.DoggoApp.viewmodels.MainViewModelFactory
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        changeDogButton.setOnClickListener {
            ...
            val newDogImage = currentImgUrl?.let { it1 -> DogEntity(imageUrl = it1) }
